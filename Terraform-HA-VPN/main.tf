################## Create Two VPCs with Subnets Each ###########################
...
################## Create HA VPN Gateway in Delhi region###########################
...
################## Create Cloud Router for both the VPCs ###########################
...
################## configuring settings for a BGP (Border Gateway Protocol) session at each tunnel###########################
